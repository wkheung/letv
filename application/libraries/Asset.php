...
class Asset {
	...
	public function css($asset_name, $module_name = NULL, $attributes = array())
	{
		...
		return '<link href="' . base_url() . $this->css_path($asset_name, $module_name) . '" type="text/css"' . $attribute_str . ' />' . "\n";
	}
	...
	public function image($asset_name, $module_name = '', $attributes = array())
	{
		...
		return '<img src="' . base_url() . $this->image_path($asset_name, $module_name) . '"' . $attribute_str . ' />' . "\n";
	}
	...
	{
		return '<script type="text/javascript" src="' . base_url() . $this->js_path($asset_name, $module_name) . '"></script>' . "\n";
	}
